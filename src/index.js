...
function generatePoem(event) {
  ...
  let context =
    "Create a short, four line poem that is lighthearted and sweet based on the user input. Seperate each line of the poem using <br>. Sign the poem at the bottom with a single emoji that relates to the poem.";
